...
namespace NoSQLWinForms
{
    internal static class Program
    {
        ...
        {            
            ...
            //estudantes.Add(new Estudante("João Sharp", 21, "Engenharia de Software", "mail@mail.com"));
            //livros.Add(new Livro("123456789", "1489", "Big Brother Returns", "Orge Georwell", new DateTime(2000, 10, 01), "Porto Editora", 297, "A tão aclamada sequela."));
